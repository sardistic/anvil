...
const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': "default-src 'none'; script-src 'self' 'unsafe-inline' https://analytics.sardistic.com; style-src 'unsafe-inline'; img-src 'self' data:; connect-src 'self' https://analytics.sardistic.com; base-uri 'none'; form-action 'none'; frame-ancestors 'self'",
};
